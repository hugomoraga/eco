...
from core.ports import ActionCommand, QuitCommand, encode, decode, MessageType
...
class EcoTextualApp(App):
    ...
    def __init__(self, cli_args: list[str] | None = None, theme_name: str = "nebula", **kwargs):
        ...
        self._cli_args = cli_args or [sys.executable, "-m", "core.cli", "--max-turns", "100"]
        self._turn = 0
        self._world_tick = 0
        self._pressure = 30.0
    ...
    def _handle(self, d: dict) -> None:
        from adapters.tui.textual.colors import GREEN, RED, CYAN, YELLOW, WHITE
...
if __name__ == "__main__":
    ...
    cli = [sys.executable, "-m", "core.cli", "--max-turns", str(args.max_turns), "--seed", str(args.seed)]
