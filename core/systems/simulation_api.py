...
from core.systems.action_registry import ACTION_CLASSES, get_action
from core.systems.turn_context import handle_npc_damage_to_player, track_echo_action
...
class SimulationAPI:
    ...
    def _snapshot_metrics(self) -> dict:
        from core.systems.turn_context import snapshot_metrics
