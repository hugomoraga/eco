...
CRISIS_DATA: dict[CrisisType, dict] = {
    CrisisType.FOOD_SHORTAGE: {
        ...
        "effects": {"legitimacy_change": -5.0, "pressure_change": 10.0, "resources_change": -10.0, "vitality_change": -5.0},
    },
    CrisisType.COMMUNICATION_FAILURE: {
        ...
        "effects": {"legitimacy_change": -3.0, "pressure_change": 5.0, "resources_change": 0.0, "vitality_change": 0.0},
    },
    CrisisType.PROTEST: {
        ...
        "effects": {"legitimacy_change": 5.0, "pressure_change": 15.0, "resources_change": -5.0, "vitality_change": -3.0},
    },
    CrisisType.DISEASE: {
        ...
        "effects": {"legitimacy_change": -8.0, "pressure_change": 8.0, "resources_change": -15.0, "vitality_change": -15.0},
    },
    CrisisType.REPRESSION: {
        ...
        "effects": {"legitimacy_change": -10.0, "pressure_change": 20.0, "resources_change": -5.0, "vitality_change": -8.0},
    },
    CrisisType.PROSPERITY: {
        ...
        "effects": {"legitimacy_change": 8.0, "pressure_change": -5.0, "resources_change": 15.0, "vitality_change": 5.0},
    },
    CrisisType.SHORTAGE: {
        ...
        "effects": {"legitimacy_change": -5.0, "pressure_change": 8.0, "resources_change": -12.0, "vitality_change": -3.0},
    },
}
