...
def process_circle_activities(
    world, rng, seed: int, turn: int, ai_adapter, notify, log, log_event
) -> None:
    """
    Process circle activities at turn start (spec-28).
    """
    from core.factories import create_npc, process_circle_tick
    ...
    try:
        ...
        log.error(
            "process_circle_activities_failed",
            turn=turn,
            error=str(e),
