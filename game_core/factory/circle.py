...
if TYPE_CHECKING:
    from game_core.domain.entities import Circle, Echo, Ideas, World
...
def create_circle(
    ...
    from game_core.domain.entities import Circle, CircleEvent
    from game_core.domain.enums import CircleEventType
...
def _spawn_npc_in_circle(circle: Circle, world: World, rng) -> str | None:
    ...
    from game_core.factory.npc import create_npc
